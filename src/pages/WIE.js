...
//Ana logo
import Logo from '../images/ieeekouwie_beyaz.png';
...
import Sliderap1 from '../images/teatalk.png';
import Sliderap2 from '../images/wie.png';
import Sliderap3 from '../images/wie1.png';
import Sliderap4 from '../images/wie2.png';
...
const WIE = () => {
    ...
    return ( <
        ...
        <
        h1 style = {
            { textAlign: "center", marginTop: 50 } } > Why Not ? < /h1> <
        Container style = {
            { marginTop: 50 } } >
        <
        Row className = "justify-content-md-center" >
        ...
        <
        h1 style = {
            { textAlign: "center", marginTop: 50 } } > DİĞER ETKİNLİKLERİMİZ < /h1> <
        Container style = {
            { marginTop: 50 } } >
        <
        Row className = "justify-content-center align-items-center" >
